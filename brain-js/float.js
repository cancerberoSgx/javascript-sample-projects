...
Float.prototype.toBitArray = function() {
  return this.toBitString().split('').map(Number)
};
function floatToBinaryArray(a) {
  return new Float(a).toBitArray()
}

module.exports = floatToBinaryArray
// console.log(floatToBinaryArray(0.122));
