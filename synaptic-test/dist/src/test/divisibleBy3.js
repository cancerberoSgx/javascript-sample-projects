...
function main() {
    ...
    console.log(network.activate(inputUtil_1.buildNumber(101, numberSize)));
    console.log(network.activate(inputUtil_1.buildNumber(102, numberSize)));
}
main();
//# sourceMappingURL=divisibleBy3.js.map